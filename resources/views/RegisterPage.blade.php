    ...
    <div class="flex-grow flex items-center justify-center px-6 py-8">
        <div class="w-full max-w-md bg-white">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-400 text-sm">Lengkapi data diri Anda untuk mendaftar</p>
            </div>
            ...
            <form action="{{ url('/login') }}" method="GET"> 
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="w-full px-5 py-3 rounded-lg input-gray text-slate-700 placeholder-slate-300 font-medium" placeholder="Nama lengkap sesuai SK">
                </div>

                <div class="mb-4">
                    <label class="block text-slate-600 text-sm font-bold mb-2">Nomor HP / WhatsApp</label>
                    <input type="text" class="w-full px-5 py-3 rounded-lg input-gray text-slate-700 placeholder-slate-300 font-medium" placeholder="0812xxxx">
                </div>
                ...
                <div class="mb-8">
                    <label class="block text-slate-600 text-sm font-bold mb-2">Konfirmasi Password</label>
                    <input type="password" class="w-full px-5 py-3 rounded-lg input-gray text-slate-700 placeholder-slate-300 font-medium tracking-widest" placeholder="********">
                </div>

                <button type="submit" class="w-full bg-custom-red text-white font-bold py-3.5 rounded-xl shadow-lg shadow-red-900/20 hover:bg-[#7a1818] transition duration-300 mb-6">
                    Daftar
                </button>
            ...
            <div class="text-center text-sm text-slate-400 mb-8">
                <p>Sudah punya akun? <a href="{{ url('/login') }}" class="text-custom-red font-bold hover:underline">Masuk</a></p>
            </div>

            <div class="text-center">
                <a href="{{ url('/') }}" class="text-slate-400 hover:text-custom-red text-sm flex items-center justify-center gap-2 transition">
