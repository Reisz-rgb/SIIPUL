...
<head>
    ...
    <title>E-CUTI - Disdikbudpora Kab. Semarang</title>
...
<body class="bg-white">
    ...
    <header class="bg-[#9E2A2B] text-white py-4 shadow-md">
        <div class="container mx-auto px-6 flex justify-between items-center">
            ...
            <a href="{{ url('/login') }}"
               class="bg-white text-[#9E2A2B] px-6 py-2 rounded-md font-bold text-sm flex items-center gap-2 hover:bg-gray-100 transition shadow-sm">
    ...
    <section class="text-center pt-16 pb-12 bg-white">
        <div class="container mx-auto px-4">
            ...
            <h1 class="text-black font-extrabold text-5xl mb-8">E-CUTI</h1>
            ...
            <div class="max-w-2xl mx-auto text-gray-600 text-sm leading-relaxed">
                <p class="font-bold text-gray-800">
                    ...
                    <span class="font-normal text-gray-600">Disdikbudpora Kab. Semarang. Aplikasi</span>
                </p>
        ...
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex justify-center">
                <div class="bg-white rounded-xl shadow-lg p-8 w-full max-w-sm hover:shadow-xl transition duration-300 border border-gray-100">
                    ...
                    <a href="{{ url('/login') }}"
                       class="block w-full bg-[#9E2A2B] text-white font-semibold py-3 rounded-lg hover:bg-red-800 transition flex justify-center items-center gap-2">
                        Ajukan Sekarang
