...
<head>
    ...
    <title>Hubungi Kami - E-CUTI</title>
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="bg-custom-red text-white p-8 md:w-1/3 flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="mt-12 text-[10px] opacity-60 text-center relative z-10">
                    E-CUTI &copy; 2026 Disdikbudpora
                </div>
            </div>
                ...
                <form action="#" method="POST">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-[#961E1E] focus:ring-1 focus:ring-[#961E1E] transition">
                        </div>
                        <div>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea rows="4"
                                  ...
                                  class="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:border-[#961E1E] focus:ring-1 focus:ring-[#961E1E] transition resize-none"></textarea>
                    </div>

                    <div class="flex justify-end">
                        <button type="button"
                                onclick="kirimPesan()"
                                class="bg-custom-red text-white font-bold py-3 px-8 rounded-lg shadow hover:bg-[#7a1818] transition flex items-center gap-2">
