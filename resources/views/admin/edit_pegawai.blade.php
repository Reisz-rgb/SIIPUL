    ...
    <div class="d-flex justify-content-between align-items-start">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="text-white text-opacity-75 m-0 small mt-1">Perbarui informasi pegawai dengan teliti.</p>
            </div>
        </div>
        ...
        <form id="formEditPegawai" action="{{ route('admin.pegawai.update', $pegawai->id) }}" method="POST">
            ...
            <div class="row g-4">
                <input type="hidden" name="join_date"
                       value="{{ old('join_date', optional($pegawai->join_date)->format('Y-m-d') ?? $pegawai->join_date) }}">
                <input type="hidden" name="annual_leave_quota"
                       value="{{ old('annual_leave_quota', $pegawai->annual_leave_quota ?? 12) }}">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="bidang_unit"
                               ...
                               value="{{ old('bidang_unit', $pegawai->bidang_unit) }}"
