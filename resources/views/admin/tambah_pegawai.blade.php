...
<div class="dashboard-container">
            <div class="card-content">
                ...
                <div class="alert alert-primary d-flex align-items-start gap-3 border-0 rounded-3 mb-4" style="background-color: #EFF6FF; color: #1E40AF;">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                       value="{{ old('name') }}" placeholder="Nama Lengkap Beserta Gelar" required>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="nip" class="form-control @error('nip') is-invalid @enderror" 
                                       value="{{ old('nip') }}" placeholder="19xxxxxxxxxx" required>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" 
                                       value="{{ old('email') }}" placeholder="contoh@semarangkab.go.id" required>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="jabatan" class="form-control @error('jabatan') is-invalid @enderror" 
                                       value="{{ old('jabatan') }}" placeholder="Contoh: Staf Teknis" required>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="bidang_unit" class="form-control @error('bidang_unit') is-invalid @enderror" 
                                       value="{{ old('bidang_unit') }}" placeholder="Contoh: Dinas Kominfo" required>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                         ...
                         <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="annual_leave_quota" class="form-control @error('annual_leave_quota') is-invalid @enderror" 
                                       value="{{ old('annual_leave_quota', 12) }}" placeholder="12" required>
