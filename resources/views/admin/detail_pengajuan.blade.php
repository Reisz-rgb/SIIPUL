...
@section('title', 'Detail Pengajuan - E-CUTI')
    ...
    <div class="d-flex justify-content-between align-items-start">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="text-white text-opacity-75 m-0 small mt-1">Periksa detail pengajuan cuti sebelum diproses.</p>
            </div>
        </div>
...
<div class="dashboard-container">
    ...
    <div class="mb-3">
        <a href="{{ route('admin.kelola_pengajuan') }}"
           class="text-white text-decoration-none small opacity-75 hover-opacity-100 fw-medium">
                ...
                <div class="detail-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="p-4 bg-light rounded-3 border border-light text-dark"
                                 style="font-size: 0.95rem; line-height: 1.6; background-color: #F8FAFC;">
                                {{ $pengajuan->reason }}
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mt-4 pt-4 border-top border-dashed">
                        ...
                        @if($pengajuan->file_path)
                            <div class="file-box">
                                ...
                                <a href="{{ route('admin.pengajuan.lampiran', $pengajuan->id) }}"
                                   target="_blank"
                ...
                <div class="decision-card-container">
                    ...
                    <form action="{{ route('admin.pengajuan.update', $pengajuan->id) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea class="form-control bg-white" name="rejection_reason" rows="3"
                                      placeholder="Tulis catatan persetujuan atau alasan penolakan..."
                                      style="font-size: 0.9rem;">{{ $pengajuan->rejection_reason }}</textarea>
                        </div>

                        <button type="submit"
                                class="btn btn-primary w-100 py-3 rounded-pill fw-bold shadow-sm mt-4"
