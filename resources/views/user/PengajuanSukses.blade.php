        ...
        <section class="bg-white rounded-3xl shadow-soft border border-slate-100 overflow-hidden">
            <div class="p-8 md:p-10 text-center">
                ...
                <p class="text-slate-500 font-medium mt-3 leading-relaxed">
                    Terima kasih. Pengajuan Anda sedang diproses. Anda bisa memantau statusnya melalui menu <span class="font-extrabold text-slate-800">Riwayat Cuti</span>.
                </p>

                <div class="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="{{ route('user.riwayat') }}" class="btn-primary text-white px-7 py-3.5 rounded-2xl font-extrabold inline-flex items-center justify-center gap-2">
                        <i class="bi bi-clock-history"></i>
                        Lihat Riwayat
                    </a>
                    <a href="{{ route('user.dashboard') }}" class="bg-white border border-slate-200 text-slate-700 px-7 py-3.5 rounded-2xl font-extrabold inline-flex items-center justify-center gap-2 hover:bg-slate-50 transition">
