...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .donut{ width:150px; height:150px; border-radius:50%; background: conic-gradient(#22c55e 0 82%, #f59e0b 82% 88%, #ef4444 88% 100%); position:relative; }
...
<body>
  ...
  <div class="container">
    ...
    <div class="stats">
      <div class="stat">
        <div><div class="slabel">Total Cuti</div><div class="svalue" style="color:var(--primary);">12</div><div class="ssub">hari cuti per tahun</div></div>
        <div class="sicon"></div>
      </div>
      <div class="stat">
        <div><div class="slabel">Cuti Digunakan</div><div class="svalue" style="color:var(--ok);">4</div><div class="ssub">dari 12 hari</div></div>
        <div class="sicon" style="color:var(--ok)"></div>
      </div>
      <div class="stat">
        <div><div class="slabel">Sisa Cuti</div><div class="svalue" style="color:var(--rej);">8</div><div class="ssub">hari tersisa</div></div>
        <div class="sicon" style="color:var(--rej)"></div>
      </div>
    </div>
  ...
  <div id="msg-toast">
      ...
      <button class="toast-close" onclick="closeToastNotif()">
