...
<head>
    ...
    <title>Lupa Password - E-CUTI</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen py-10">
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-xl overflow-hidden relative">
        ...
        <div class="bg-[#9E2A2B] py-8 px-8 text-center text-white border-b-4 border-[#802223]">
            ...
            <h1 class="text-2xl font-bold tracking-wide mb-1">E-CUTI</h1>
        ...
        <div class="p-10">
            ...
            <form action="{{ route('password.email') }}" method="POST">
                ...
                <button type="submit"
                        class="w-full bg-[#9E2A2B] text-white font-bold py-3 rounded-lg hover:bg-red-800 transition shadow-md mb-8">
                    Kirim Link Reset
                </button>
