...
<head>
    ...
    <title>Panduan Login - E-CUTI</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen py-10">
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden">
        ...
        <div class="bg-[#9E2A2B] p-8 text-center text-white">
            ...
            <h1 class="text-2xl font-bold tracking-wide">Panduan Login E-CUTI</h1>
        ...
        <div class="p-8">
            ...
            <div class="text-center mt-8 space-x-4">
                <a href="{{ route('login') }}"
                   class="inline-block bg-[#9E2A2B] text-white font-bold py-3 px-6 rounded-lg hover:bg-red-800 transition">
                    Login Sekarang
                </a>
                <a href="{{ route('register') }}"
                   class="inline-block bg-gray-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-gray-700 transition">
                    Daftar Akun
                </a>
            </div>
